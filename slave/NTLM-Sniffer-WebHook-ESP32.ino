...
void setupWebUI() {
  ...
  WiFi.softAP("NTLM-ESP32", "7h30th3r0n3");
  Serial.println("[*] Configuration Mode Enabled");
  Serial.println("[+] Connect to Wi-Fi: NTLM-ESP32");
...
void setup() {
  Serial.begin(115200);
  Serial.print("Booting... Waiting for config trigger...");
  delay(3000);
  ...
  if (WiFi.status() != WL_CONNECTED) {
    Serial.print("\nFail to connect... Setup Config WebUI...");
